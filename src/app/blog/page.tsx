  ...
  const posts = [
    {
      ...
      excerpt: "Learn the essential steps to structure and write a professional academic report.",
    ...
    },
    {
      ...
      excerpt: "A comprehensive guide to Harvard, APA, and Chicago referencing styles.",
    ...
    },
    {
      ...
      excerpt: "Practical strategies to manage your workload and meet deadlines effectively.",
      category: "Study Tips",
      date: "Oct 10, 2025",
      readTime: "6 min read",
    },
    {
      ...
      excerpt: "Master the art of finding and evaluating credible academic sources.",
      category: "Research",
      date: "Oct 8, 2025",
      readTime: "8 min read",
    },
      ...
      <section className="bg-gradient-to-b from-slate-50 to-white dark:from-slate-900 dark:to-slate-950 py-20 md:py-32">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto text-center">
            <h1 className="text-4xl md:text-5xl font-bold mb-6">Student Success Blog</h1>
