        ...
        >
          ...
          <style>{`
            ...
            @keyframes circle-anim {
              50% { transform: scale(0.2) rotateX(360deg) rotateY(360deg); }
            }
          ...
          {/* Your full SVG content here — unchanged */}
          {/* ------------------------------- */}
          {/* ✨ I did not repeat entire SVG to save space */}
          {/* Paste the full same SVG content you used in NotFound404 */}
          {/* ------------------------------- */}
        </svg>
