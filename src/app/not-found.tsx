...
export default function NotFound() {
  return (
    <div className="flex min-h-screen flex-col items-center justify-center transition-colors bg-white dark:bg-[#0A0F1E]">
      {/* SVG Animation */}
      ...
      <div className="text-center mt-8 px-4">
        <h1 className="text-4xl md:text-5xl font-bold mb-4 transition-colors text-[#111E2F] dark:text-white">
          Page Not Found
        </h1>
        <p className="text-lg md:text-xl mb-8 max-w-2xl mx-auto transition-colors text-[#284366] dark:text-[#CBD5E1]">
